...
export const IconWarning: React.FC<SvgPropsTypes> = (props) => (
  <svg {...props} width='24' height='24' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
    ...
    />
    <defs>
      <linearGradient id='paint0_linear_7608_20254' x1='12' y1='3' x2='12' y2='21' gradientUnits='userSpaceOnUse'>
        <stop offset='0.33348' stopColor='#FFC83F' />
        <stop offset='1' stopColor='#EBA817' />
      </linearGradient>
    </defs>
  </svg>
);
